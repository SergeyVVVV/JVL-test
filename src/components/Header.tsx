...
export default function Header() {
  ...
  const disableHide = isHomePage || /\/blog-and-news/.test(pathname) || /\/echo-b2b/.test(pathname) || /\/flex/.test(pathname) || /\/games/.test(pathname) || /\/warranty/.test(pathname) || /\/about-jvl/.test(pathname) || /\/partners/.test(pathname)
  useEffect(() => {
